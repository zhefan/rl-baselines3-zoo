...
if __name__ == "__main__":  # noqa: C901
    ...
    parser.add_argument("--pretrain", type=str, default=None, help="pretrained encoder path")
    parser.add_argument("--encfreeze", action="store_true", default=False, help="Freeze pretrained encoder weights")
